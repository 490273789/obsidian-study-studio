...
export const flashcardTranslations = {
	zh: {
		...
		"home.totalCards": "总卡片",
		"home.totalCardsBadge": "{count} 张卡片",
		"home.totalCardsTooltip": "总卡片数：{count} 张",
		...
		"home.videoPlayerTitle": "本地视频",
		"home.emptyTitle": "暂无题库",
		"home.emptyHint": "点击刷新按钮扫描带有 {tag} 标签的文件",
		"footprint.title": "学习足迹",
		"footprint.subtitle": "今天的投入与过去一年的通关记录",
		"footprint.currentStreak": "连续 {count} 天",
		"footprint.bestStreak": "最佳 {count} 天",
		"footprint.studyAnswers": "学习",
		...
		"footprint.less": "少",
		"footprint.more": "多",
		"footprint.legendLabel": "通关作答量图例",
		"footprint.gridLabel": "过去一年的学习热力图",
		"footprint.mondayShort": "一",
		"footprint.wednesdayShort": "三",
		"footprint.fridayShort": "五",
		"footprint.dayLabel": "{date}，通关作答 {count} 次",
		"footprint.completedBreakdown":
			"通关作答 {count} 次 · 学习 {study} · 练习 {practice} · 拼写 {spelling}",
		"footprint.activeNotCompleted": "有活动，未通关",
		"footprint.noActivity": "暂无活动",
		"footprint.dayDuration": "总时长 {duration} · 生词表 {wordList}",
	...
	en: {
		...
		"home.totalCardsBadge": "{count} cards",
		"home.totalCardsTooltip": "Total cards: {count}",
		...
		"home.videoPlayerTitle": "Local Video",
		"home.emptyTitle": "No decks",
		"home.emptyHint": "Click refresh to scan files tagged with {tag}",
		"footprint.title": "Learning Footprint",
		"footprint.subtitle": "Today's effort and your completion record for the past year",
		"footprint.currentStreak": "{count}-day streak",
		"footprint.bestStreak": "Best {count} days",
		"footprint.studyAnswers": "Study",
		"footprint.practiceAnswers": "Practice",
		"footprint.spellingAnswers": "Spelling",
		"footprint.totalDuration": "Total time",
		"footprint.wordListDuration": "Word list {duration}",
		"footprint.times": "times",
		"footprint.pastYear": "Past year",
		"footprint.less": "Less",
		"footprint.more": "More",
		"footprint.legendLabel": "Completed-answer intensity legend",
		"footprint.gridLabel": "Learning heatmap for the past year",
		"footprint.mondayShort": "M",
		"footprint.wednesdayShort": "W",
		"footprint.fridayShort": "F",
		"footprint.dayLabel": "{date}, {count} completed answers",
		"footprint.completedBreakdown":
			"{count} completed answers · Study {study} · Practice {practice} · Spelling {spelling}",
		"footprint.activeNotCompleted": "Activity recorded, no completed session",
		"footprint.noActivity": "No activity",
		"footprint.dayDuration": "Total {duration} · Word list {wordList}",
